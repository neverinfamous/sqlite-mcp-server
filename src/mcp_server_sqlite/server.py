...
This server demonstrates SQLite database operations through the Model Context Protocol (MCP).
...
Available Resources:
- memo://insights: Business insights memo that updates automatically

The server provides comprehensive SQLite database interaction capabilities with transaction safety, JSON support, and business intelligence features.
"""
